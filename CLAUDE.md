...
- TSP tabanlı rota optimizasyonu (`solveTSP`, `bestOrder`, `cheapestInsert`, 2-opt tarzı `optimizeSeq`/`refine`) ile en kısa/en hızlı teslimat sırası hesaplanıyor.
...
- Henüz üzerinde yeni bir özellik geliştirilmedi; bu oturumda yapılan iş sadece git/GitHub kurulumu ve proje hafızasının oluşturulmasıydı.
